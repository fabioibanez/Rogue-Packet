...
def main():
    # clear && python -m bittorrent_deployer.generate_sources --source-dir seeder_sources --torrents-dir torrents --config-dir bittorrent_deployer/ --template bittorrent_deployer/config.yaml --size 1048576 --count 10
